...
# =================== time series =================== 
ts_directory <- "processed/wisewb/included_winter_months/wisewb_time_series"
...
directory <- "processed/wisewb/included_winter_months/wisewb_raster"
...
extractMTBQ <- function(variable) {
  ...
  fdirectory <- paste0('processed/wisewb/included_winter_months/wisewb_raster/raster/', variable)
...
# saveRDS(EC_MTBQ, file=paste0("processed/wisewb/included_winter_months/wisewb_raster/MTBQ/EC_MTBQ.rds"))

# herbicide
herbicide_MTBQ <- extractMTBQ("herbicide")


PO4_MTBQ <- readRDS("processed/wisewb/included_winter_months/wisewb_raster/MTBQ/PO4_MTBQ.rds")
...
for (i in 1:length(wb_waterquality_vars)) {
  ...
  ggsave(filename = paste0("processed/wisewb/included_winter_months/wisewb_trends_maps_by_site_min6years_(ggmap_version)/", wb_waterquality_vars[i], "_Trends_bw.png"), 
         trendsMap2)
...
# tmap version
trends_tmap_directory <- "processed/wisewb/included_winter_months/wisewb_trends_maps_by_site_min6years"
...
# =================== mean maps ===================
means_tmap_directory <- "processed/wisewb/included_winter_months/wisewb_means_maps_by_site_min8years"
